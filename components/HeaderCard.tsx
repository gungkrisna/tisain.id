  ...
  return (
    <Link href={href ? href : ""} target={newTab ? "_blank" : ""} onClick={onClick} >
        <span
          ...
          onClick={onClick}
        >
          <Image src={image} alt={title} width={960} height={540} quality={50} priority className="aspect-video" />
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6">
            <h5 className="text-lg lg:text-xl font-regular leading-tight text-white">
              {title}
            </h5>
          </div>
        </span>
