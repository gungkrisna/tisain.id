...
export const Header = () => {
  ...
  return (
    <>
      ...
      <header className="z-20 sticky top-0 left-0 w-full border-b border-white/[0.08] bg-black/50 backdrop-blur-[12px]">
        <Container className="flex h-navigation-height">
          ...
          <div className="ml-auto h-full hidden items-center md:flex">
