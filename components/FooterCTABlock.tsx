...
export const FooterCTABlock = () => {
    return (
        <section className="bg-blue-500">
            <Container className="flex flex-col w-full h-full justify-center gap-12 pt-[10rem]">
                <Hero>
                ...
                <img className="border-[0.25rem] border-white/25 border-solid border-b-0 rounded-t-2xl" src="/images/google-slide.png" alt="Hero image" />
            </Container>
        </section>
    )
}